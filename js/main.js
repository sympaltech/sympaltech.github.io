(function ($) {
    ...
    (function ($) {
        ...
        // Variables
        var $html = $('html'),
            $elementCarousel = $('.bently-element-carousel');
    ...
    $('.btn-search-click').on("click", function (e) {
        e.preventDefault(),
            function () {
                ...
                var e = $('.bently-search-popup').find("form input[type='search']");
                setTimeout(function () {
                    e.focus()
                }, 500)
            }()
    ...
    $('.bently-search-popup').on('click', function (e) {
    ...
    $(function() {
        ...
        $('.audio-list-tab').on('click', 'a', function () {
            ...
            $this.closest('.bently-coustom-audio-player-area').css('background-image', 'url('+ $imageSrc + ')');
        })
